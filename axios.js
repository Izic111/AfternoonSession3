...
.then(res => {
    ...
    document.getElementById("image4").src = "https://project1-bonsai-jacobtimms.vercel.app/" + res.data[4].productImage;
    ...
    document.getElementById("image5").src = "https://project1-bonsai-jacobtimms.vercel.app/" + res.data[5].productImage;
    ...
    document.getElementById("image6").src = "https://project1-bonsai-jacobtimms.vercel.app/" + res.data[6].productImage;
    })
